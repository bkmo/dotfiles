...
rm $kdeinstdir/share/kservices5/ServiceMenus/kim_*.desktop
rm $kdeinstdir/bin/kim_*
rm -rf $kdeinstdir/share/kim
mv $kdeinstdir/share/kservices5/ServiceMenus/imageconverter.desktop~ $kdeinstdir/share/kde4/services/ServiceMenus/imageconverter.desktop
